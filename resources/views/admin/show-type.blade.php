                ...
                <li class="mb-5">
                    <form class="form-inline" method="post" action="{{ route('admin-update-type', $type->id) }}">
                        ...
                        <div class="form-group">
                            <input class="@error('name') is-invalid @enderror" type="text" name="name" placeholder="Ime"
                                value="{{ $type->name }}" required />
                            <input class="@error('description') is-invalid @enderror" type="text" name="description"
                                placeholder="Opis" value="{{ $type->description }}" required />
